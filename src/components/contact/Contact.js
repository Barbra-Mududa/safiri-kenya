      ...
      <div className='cont'>
        ...
        <div className='cont2'>
            ...
            <form action="#" id='contact_form'>
              ...
              <textarea type="text-area" id='text' name='Text' placeholder='' rows='5' cols='57'/><br />
              <h4 id='hd4'>Service required</h4> 
              <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/>
              <label htmlFor="vehicle1" className='label2'> Camping Sites </label><br/>
              <input type="checkbox" id="vehicle2" name="vehicle2" value="Car"/>
              <label htmlFor="vehicle2" className='label2'> Hiking Trails</label><br/>
              <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"/>
              <label htmlFor="vehicle3" className='label2'>Wild Safaris</label><br/> <br />
